...
- use chimpanzee data to model multiple varying intercepts and/or slopes
    ...
    * varying slopes for prosocial option and the interaction between prosocial and the prescence of another chimpanzee
- *non-centered parameterization* (see later for explination and example)
...
- usee *non-centered parameterization* to help with potentially diverging chains
